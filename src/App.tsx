...
const App: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Scroll Progress Bar */}
      <div
        className="fixed top-0 left-0 h-1 bg-accent z-[210] transition-all duration-300"
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 py-4 flex items-center justify-between gap-8">
          ...
          >
            <div className="relative w-11 h-11 rounded-full bg-gradient-to-br from-accent via-accent2 to-accent3 p-[2px] shadow-sm group-hover:scale-105 transition-all duration-300 overflow-hidden">
              <img
                src={`${import.meta.env.BASE_URL}img/kisakye-paul-software-expert.jpg`}
                alt="KP"
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-[10px] text-accent font-black uppercase tracking-[0.25em] mt-1.5">
                Software Expert
              </p>
            </div>
          </div>
              ...
              <a
                ...
                className={`px-4 py-2 rounded-xl text-[12px] font-bold uppercase tracking-[0.12em] transition-all duration-300 ${
                  activeSection === link.id
                    ...
                    : 'text-ink/50 hover:text-accent hover:bg-accent/5'
                }`}
              >
                {link.label}
              </a>
        ...
        <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 space-y-10 text-center lg:text-left reveal active">
            <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-accent/5 border border-accent/20 backdrop-blur-sm">
              ...
              <span className="text-[11px] font-black text-accent/80 uppercase tracking-[0.2em]">
                Ready for work
              </span>
            </div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-black leading-[1.05] tracking-tighter">
              I Build{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent via-accent2 to-accent3">
                Apps
              </span>{' '}
              <br />
            ...
            <p className="text-lg md:text-2xl text-ink/40 max-w-2xl mx-auto lg:mx-0 font-medium leading-relaxed">
              I make fast and safe apps for web and mobile. They work well and help your business
              scale.
            </p>
      ...
      <section id="portfolio" className="py-28 px-6 border-b border-accent/10">
        <div className="max-w-[1440px] mx-auto space-y-16">
          <div className="text-center space-y-5 reveal active">
            ...
            <p className="text-xl md:text-2xl text-ink/30 font-medium max-w-3xl mx-auto">
              Here are some apps I built. They work well and help people.
            </p>
          </div>
            ...
            <div className="relative glass rounded-section overflow-hidden shadow-2xl border-accent/30 group/carousel bg-bg1">
              ...
              >
                {PROJECTS.map((project) => (
                  <div
                    key={project.id}
                    className="w-full shrink-0 relative h-[550px] md:h-[750px] overflow-hidden group"
                  >
                    <img
                      src={project.image}
                      alt={project.title}
                    ...
                    <div className="absolute top-6 right-6 md:top-10 md:right-10 z-20 max-w-[240px] md:max-w-[320px]">
                      <div className="glass p-5 md:p-6 rounded-[1.5rem] backdrop-blur-xl bg-white/10 dark:bg-black/40 border border-white/20 shadow-2xl transform transition-all duration-500 group-hover:bg-white/15 dark:group-hover:bg-black/50 group-hover:-translate-y-1">
                        <div className="text-right space-y-2">
                          <span className="inline-block px-2.5 py-1 rounded-full bg-accent text-[9px] font-black uppercase tracking-widest text-white shadow-lg mb-1">
                            {project.category}
                          </span>
                          <h3 className="text-lg md:text-2xl font-black text-white drop-shadow-md leading-tight">
                            {project.title}
                          </h3>
                          ...
                          <div className="flex flex-wrap justify-end gap-1.5 pt-2">
                            {project.tech.slice(0, 3).map((t) => (
                              <span
                                key={t}
                                className="text-[8px] font-mono font-bold bg-white/20 px-2 py-1 rounded-lg text-white border border-white/10 backdrop-blur-md"
                              >
                                {t}
                              </span>
                            ))}
              ...
              <div className="absolute bottom-8 right-1/2 translate-x-1/2 md:translate-x-0 md:right-8 flex gap-3 z-30">
                <button
                  ...
                  className="w-12 h-12 md:w-16 md:h-16 rounded-full glass border-white/20 flex items-center justify-center text-white hover:bg-accent hover:border-accent transition-all shadow-2xl active:scale-90"
                >
      ...
      <section id="experience" className="py-28 px-6 bg-accent/[0.03]">
        <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          <div className="space-y-12 reveal active">
            ...
            <p className="text-xl text-ink/30 font-medium">
              I have built big apps for over 7 years. I make sure they work for everyone.
            </p>
            <div className="grid grid-cols-1 gap-8">
              {[
                {
                  title: 'AI Helper',
                  desc: 'I use AI to make apps work smarter and faster.',
                  icon: Zap,
                },
                {
                  title: 'Safe Design',
                  desc: 'I keep your data safe with strong security.',
                  icon: Lock,
                },
                {
                  title: 'Modern Tools',
                  desc: 'I use the best tools to build apps that can grow.',
                  icon: Box,
                },
              ].map((item, i) => (
                <div key={i} className="flex gap-8 items-start group">
                  ...
                  <div className="text-left">
                    <h4 className="text-3xl font-black mb-1 group-hover:text-accent transition-colors tracking-tight">
                      {item.title}
                    </h4>
          ...
          <div className="glass p-12 rounded-section border-accent/30 shadow-2xl bg-gradient-to-br from-accent/[0.05] to-transparent reveal active relative overflow-hidden">
            ...
            <p className="text-ink/40 text-xl mb-12">
              I build apps that load fast and stay online always.
            </p>
              ...
              {[
                ...
                <div key={s.label} className="space-y-4">
                  ...
                  <div className="h-2.5 w-full bg-accent/10 rounded-full overflow-hidden shadow-inner">
                    <div
                      className={`h-full ${s.color} transition-all duration-[2000ms] shadow-sm`}
                      style={{ width: `${s.val}%` }}
                    />
                  </div>
                </div>
            ...
            {EDUCATION.map((edu, i) => (
              <div key={i} className="relative pl-12 md:pl-24 group">
                ...
                <div className="glass p-10 rounded-[2.5rem] border-accent/20 hover:border-accent/50 transition-all shadow-xl group/card relative overflow-hidden">
                  <h3 className="text-3xl font-black text-ink mb-2 group-hover/card:text-accent transition-colors">
                    {edu.institution}
                  </h3>
      ...
      <section id="academy" className="py-28 px-6">
        <div className="max-w-[1440px] mx-auto space-y-16">
          <div className="text-center space-y-5 reveal active">
            ...
            <p className="text-xl text-ink/30 font-medium max-w-3xl mx-auto">
              A production-grade roadmap: daily plans, exercises, project specs, and deployment
              walkthroughs.
            </p>
          </div>
            ...
            <aside className="hidden lg:block">
              <nav className="sticky top-28 space-y-3">
                <div className="glass rounded-[2.5rem] p-6 border-accent/20 shadow-xl overflow-hidden relative">
                  ...
                  <h4 className="text-xs font-black uppercase tracking-[0.2em] text-accent/60 mb-6 pl-2">
                    Curriculum Map
                  </h4>
                      ...
                      <button
                        ...
                        className={`w-full text-left px-5 py-4 rounded-2xl text-[11px] font-black uppercase tracking-[0.15em] transition-all flex items-center justify-between group ${
                          activeSection === m.id
                            ...
                            : 'text-ink/40 hover:bg-accent/10 hover:text-accent'
                        }`}
                      >
                        ...
                        <ArrowRight
                          className={`w-3 h-3 transition-opacity ${activeSection === m.id ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`}
                        />
                      </button>
                    ))}
                  </div>
                ...
                <div key={module.id} id={module.id} className="scroll-mt-32 space-y-12 reveal">
                  <div className="border-b border-accent/10 pb-10 flex flex-col md:flex-row md:justify-between md:items-end gap-6 relative">
                    <div className="space-y-3">
                      ...
                      <p className="text-lg text-ink/40 font-medium max-w-2xl">
                        {module.description}
                      </p>
                    </div>
                    <div className="flex flex-col items-end gap-2">
                      <span className="text-xs font-mono font-bold text-accent px-6 py-2 bg-accent/10 border border-accent/20 rounded-2xl shadow-sm self-start md:self-auto">
                        {module.countLabel}
                      </span>
                      <span className="text-[9px] font-black uppercase tracking-widest text-ink/20 hidden md:block">
                        Reference ID: {module.id}
                      </span>
                    </div>
                  </div>
        ...
        <div className="max-w-[1250px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-24">
          <div className="space-y-16 reveal active">
            ...
            <div className="space-y-8">
              <div
                className="flex items-center gap-8 glass p-8 rounded-[2rem] border-accent/10 group cursor-pointer hover:border-accent/50 transition-all shadow-xl"
                onClick={() => window.open('https://wa.me/256774185964')}
              >
              ...
              <div
                className="flex items-center gap-8 glass p-8 rounded-[2rem] border-accent/10 group cursor-pointer hover:border-accent/50 transition-all shadow-xl"
                onClick={() => window.open('mailto:kisakyepaul73@gmail.com')}
              >
                <div className="w-16 h-16 rounded-2xl flex items-center justify-center bg-accent text-white group-hover:bg-accent2 transition-all">
            ...
            <form className="space-y-8" onSubmit={handleFormSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <input
                  required
                  type="text"
                  className="w-full glass bg-transparent border-accent/20 rounded-2xl px-6 py-4 outline-none focus:border-accent transition-all text-ink placeholder:text-ink/20 font-medium"
              ...
              <textarea
                required
                rows={5}
                className="w-full glass bg-transparent border-accent/20 rounded-[2rem] px-6 py-6 outline-none focus:border-accent transition-all resize-none text-ink placeholder:text-ink/20 font-medium"
                placeholder="How can I help you?"
              ></textarea>
              <button
                type="submit"
                className={`w-full py-6 rounded-[2rem] font-black uppercase tracking-[0.3em] text-sm transition-all shadow-xl active:scale-[0.98] ${formState === 'success' ? 'bg-green-500 text-white' : 'bg-accent text-white hover:shadow-accent-lg'}`}
              >
        ...
        <div className="max-w-[1440px] mx-auto space-y-8">
          <div className="flex items-center justify-center gap-5">
            ...
            <div className="text-left">
              ...
              <p className="text-[11px] text-accent/60 font-black uppercase tracking-[0.25em]">
                Software Expert
              </p>
            </div>
          </div>
          <p className="text-[12px] text-ink/30 font-bold uppercase tracking-[0.2em]">
            © 2025 Kisakye Paul. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
