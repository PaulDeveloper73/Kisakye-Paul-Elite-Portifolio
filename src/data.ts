...
export const MODULES: Module[] = [
  {
    ...
    countLabel: '15 Days',
    description:
      'Master core mental models of React. Cover JSX, components, props, state, events, effects, and context basics.',
    lessons: [
      {
        id: 'day-1',
        ...
        exercise: {
          ...
          code: {
            title: 'Vite Setup',
            content:
              'npm create vite@latest react18-foundations -- --template react\ncd react18-foundations\nnpm install\nnpm run dev',
            key: 'vite-setup',
          },
        },
  ...
  },
  {
    ...
    countLabel: '20 Days',
    description:
      'Learn about useReducer, hooks, performance, and routing. Build a simple Blog app.',
    lessons: [
      {
        id: 'day-16',
    ...
    lessons: [
      {
        ...
        tags: ['Spec', 'Beginner'],
        duration: '5 Days',
        criteria: ['No state mutation', 'Data saved in localStorage', 'Has basic tests'],
      },
      {
        id: 'spec-4',
        ...
        tags: ['Spec', 'Expert'],
        duration: '15 Days',
        criteria: ['Role-based access control', 'CI/CD pipeline included', 'Optimized for speed'],
      },
    ],
  },
];
...
export const PROJECTS: Project[] = [
  {
    ...
    category: 'SaaS',
    image:
      'https://images.unsplash.com/photo-1551288049-bbbda536ad85?q=80&w=2070&auto=format&fit=crop',
  ...
  },
  {
    ...
    category: 'Finance',
    image:
      'https://images.unsplash.com/photo-1611974714851-eb6051612253?q=80&w=2070&auto=format&fit=crop',
...
export const EDUCATION = [
  {
    ...
    details:
      'I studied how to build websites and computer networks. I focused on making systems safe and fast.',
  },
  {
    year: '2013 – 2014',
